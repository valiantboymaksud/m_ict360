...
trait FileSaver
{
    ...
    */
    public function upload_file($uploaded_file, $model, $database_field_name, $base_path)
    {
        ...
        if ($uploaded_file) {
            ...
            $new_file_name   = time() . '-' . $model->id . '.' . $uploaded_file->getClientOriginalExtension();
            ...
            $uploaded_file->move(public_path($directory), $new_file_name);
    ...
    */
    public function uploadFileWithResize($uploaded_file, $model, $database_field_name, $basePath, $height = 300, $width = 250)
    {
        if ($uploaded_file) {
            ...
            })->save(public_path($directory) . $new_file_name);
    ...
    */
    ...
    public function unlinkFile($model, $fieldName)
    {
